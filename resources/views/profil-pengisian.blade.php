...
<h4>Harap lengkapi profil usaha anda terlebih dahulu: </h4>
  <br>
  <form action="{{route('submit-profil')}}" method="POST" onsubmit="submitPorfil()">
      @csrf
    <div class="row">
        ...
        <div class="form-floating shadow  mb-3 rounded-pill">
          <input
            ...
            oninvalid="this.setCustomValidity(' ');
                $.toast({
                    heading: 'Mohon Lakukan',
                    text: 'Mohon Lengkapi Kolom Nama Usaha',
                    icon: 'error',
                    hideAfter: false,
                    position: 'top-right',
                    loaderBg: '#9EC600'
      ...
      <div class="row">
          <div class="col-lg-7">
              ...
              <div class="form-floating mb-3 shadow rounded-pill">
                ...
                $.toast({
                    heading: 'Mohon Lakukan',
                    text: 'Mohon Lengkapi Kolom Provinsi',
                    icon: 'error',
                    hideAfter: false,
                    position: 'top-right',
                    loaderBg: '#9EC600'
    ...
    onchange="setCustomValidity('')"
              ...
              <div class="form-floating mb-3 shadow rounded-pill">
                ...
                $.toast({
                    heading: 'Mohon Lakukan',
                    text: 'Mohon Lengkapi Kolom Kabupaten',
                    icon: 'error',
                    hideAfter: false,
                    position: 'top-right',
                    loaderBg: '#9EC600'
    ...
    onchange="setCustomValidity('')"
              ...
              <div class="form-floating mb-3 shadow rounded-pill">
                ...
                $.toast({
                    heading: 'Mohon Lakukan',
                    text: 'Mohon Lengkapi Kolom Kecamatan',
                    icon: 'error',
                    hideAfter: false,
                    position: 'top-right',
                    loaderBg: '#9EC600'
    ...
    onchange="setCustomValidity('')"
              ...
              <div class="form-floating mb-3 shadow rounded-pill">
                ...
                $.toast({
                    heading: 'Mohon Lakukan',
                    text: 'Mohon Lengkapi Kolom Kelurahan',
                    icon: 'error',
                    hideAfter: false,
                    position: 'top-right',
                    loaderBg: '#9EC600'
    ...
    onchange="setCustomValidity('')"
          ...
          <div class="col-lg-5">
              <div class="form-floating mb-3 shadow ">
                  <textarea oninvalid="this.setCustomValidity(' ');
                  $.toast({
                      heading: 'Mohon Lakukan',
                      text: 'Mohon Lengkapi Kolom Alamat',
                      icon: 'error',
                      hideAfter: false,
                      position: 'top-right',
                      loaderBg: '#9EC600'
                  });"
      onchange="setCustomValidity('')" class="form-control  shadow px-4" placeholder="Alamat Lengkap" id="alamat" name="alamat" required style="height: 130px"></textarea>

...
<head>
    ...
    <link
        href="{{ asset('https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;700&family=Poppins:wght@300;500;700&display=swap') }}"
        rel="stylesheet">
...
<body>
    ...
    {{-- Jquery --}}
    <script src="{{ asset('https://code.jquery.com/jquery-3.6.3.min.js')}} "
